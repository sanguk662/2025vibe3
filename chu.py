...
# ▶️ 3. CSV로 저장 (엑셀 대신)
csv_path = "/mnt/data/world_gdp_2010_2023_sample.csv"
...
pio.write_html(fig1, file="/mnt/data/plot_gdp_line.html", auto_open=False)
...
pio.write_html(fig2, file="/mnt/data/plot_gdp_per_capita_bar.html", auto_open=False)
...
pio.write_html(fig3, file="/mnt/data/plot_gdp_population_bubble.html", auto_open=False)
